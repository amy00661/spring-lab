...
//    }
//    private Set<GrantedAuthority> mapAuthorities(UserEntity user, List<String> roleNames, List<String> authorityNames) {
//        Set<GrantedAuthority> result = new HashSet<>();
//
//        // 角色
//        roleNames.forEach(r -> result.add(new SimpleGrantedAuthority(r)));
//
//        // 權限
//        authorityNames.forEach(a -> result.add(new SimpleGrantedAuthority(a)));
//
//        return result;
//    }
//
